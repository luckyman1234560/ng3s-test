...
make_button("rgb(173, 255, 126)", ["端", "透", "定", "泥"], "kb2", 50, 60);      
make_button("rgb(132, 175, 255)", ["莊", "初", "崇", "生", "俟"], "kb5", 450, 60); 

make_button("rgb(122, 255, 153)", ["知", "徹", "澄", "娘"], "kb3", 75, 120);     
make_button("rgb(126, 221, 255)", ["章", "昌", "常", "書", "船"], "kb6", 475, 120); 

make_button("rgb(253, 255, 120)", ["見", "溪", "群", "疑"], "kb7", 100, 180);     
make_button("rgb(255, 209, 130)", ["影", "云", "以", "曉", "匣"], "kb8", 500, 180); 

make_button("rgb(212, 125, 255)", ["來", "日"], "kb9", 700, 240); 
